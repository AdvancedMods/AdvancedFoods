...
public class ConfigurationHandler {
    ...
    private static void loadConfig() {
        ...
        checkUpdates = config.getBoolean("checkUpdates", "Updates", true, "Set this to false to disable the update checker");
        ...
        isDeveloper = config.getBoolean("isDeveloper", "Debug", false, "If true, Simulate a Dev Env, should be let to false unless you know what you are doing!!");
        jarEnabled = config.getBoolean("jarEnabled", "Items", true, "");
        jellybeansEnabled = config.getBoolean("jellybeansEnabled", "Items", true, "");
        ketchupEnabled = config.getBoolean("ketchupEnabled", "Items", true, "");
        kiwiEnabled = config.getBoolean("kiwiEnabled", "Items", true, "");
        kiwiLemonadeEnabled = config.getBoolean("kiwiLemonadeEnabled", "Items", true, "");
        kiwiSeedEnabled = config.getBoolean("kiwiSeedEnabled", "Items", true, "");
        kiwiSeedDropEnabled = config.getBoolean("kiwiSeedDropEnabled", Configuration.CATEGORY_GENERAL, true, "");
        kiwiSmoothieEnabled = config.getBoolean("kiwiSmoothieEnabled", "Items", true, "");
        knifeEnabled = config.getBoolean("knifeEnabled", "Items", true, "");
        lemonEnabled = config.getBoolean("lemonEnabled", "Items", true, "");
        lemonSeedEnabled = config.getBoolean("lemonSeedEnabled", "Items", true, "");
        lemonSeedDropEnabled = config.getBoolean("lemonSeedDropEnabled", Configuration.CATEGORY_GENERAL, true, "");
        lemonSmoothieEnabled = config.getBoolean("lemonSmoothieEnabled", "Items", true, "");
